...
export const UseMemoSample = () => {
    ...
    const onClickButton=()=>{
        setItems((prevItems)=>{
            //現在の入力値をitemsについえかする。この時新しい配列を作成して保存する
    ...
    //number OfCharacter1は再描画のたびにitems.reduceを実行して結果を得る
    ...
    return (
        <div>
            ...
            <div>
                <p>Total Number of Characters1:{numberOfCharacter1}</p>
                <p>Total Number of Characters2:{numberOfCharacter2}</p>
            </div>
        </div>
    )
}
